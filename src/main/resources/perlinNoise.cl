...
__kernel void perlinNoise(__global double* x,
                          ...
                          __global bool* normalize,
                          __global double* output,
                          __global bool* initialized,
                          __global int* grad3,
                          __global int* perm,
    ...
    if (!*initialized) {
        ...
        offsetX = nextDouble() * 256;
        offsetY = nextDouble() * 256;
        offsetZ = nextDouble() * 256;
    ...
    output[gid] = noise(x[gid], y[gid], z[gid],
                        *octaves, *frequency, *amplitude, normalize,
                        *offsetX, *offsetY, *offsetZ,
                        *perm);
}